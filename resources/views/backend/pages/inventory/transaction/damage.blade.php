...
@section('breadcrumbs')
    <span>INVENTORY</span> / <span class="highlight">DAMAGE</span>
@endsection

@section('content')
<div class="row">
    <div class="col-md-12">
        <table id="damage_table" class="table table-striped" style="width:100%"></table>
    </div>
</div>
...
@section('scripts')
    ...
    <script src="/js/backend/pages/inventory/transaction/damage.js"></script>
@endsection
