...
@section('breadcrumbs')
    <span>TRANSACTION</span> / <span class="highlight">TRANSFER HISTROY</span>
@endsection

@section('content')
<div class="row">
    <div class="col-md-12">
        <table id="history_table" class="table table-striped" style="width:100%"></table>
    </div>
</div>
...
@section('scripts')
    ...
    <script src="/js/backend/pages/inventory/transaction/transfer_history.js"></script>
@endsection
