...
@section('breadcrumbs')
    <span>TRANSACTION</span>  /  <span class="highlight">DELIVERY RECEIPT</span>
@endsection
        ...
        <div class="grid-container">
            ...
            <div class="grid-print-1">
                <div class="grid-command text-right">
                    <button class="btn btn-primary btn-sm" onclick="viewPO()">PROCESSED DR</button>
                </div>
                @include('backend.partial.dr')
            </div>
        </div>
...
<div class="sc-modal-content" id="edit_quantity_modal">
    <div class="sc-modal-dialog">
        <div class="sc-modal-header">
            <span class="sc-title-bar">DELIVERY RECEIPT DETAILS</span>
            <span class="sc-close" onclick="scion.create.sc_modal('edit_quantity_modal').hide('all')">
        ...
        <div class="sc-modal-body">
            <form id="editQuantityForm">
                @csrf
                <input type="hidden" id="purchase_order_detail_id" name="purchase_order_detail_id">
                ...
                <div class="form-group">
                    ...
                    <small id="quantity_error" class="text-danger d-none">Exceeds available quantity!</small>
                </div>
            </form>
        </div>
        <div class="sc-modal-footer text-right">
            <button type="button" class="btn btn-primary" id="save_quantity_btn" onclick="saveQuantity()">Save</button>
        </div>
    </div>
</div>

<div class="sc-modal-content" id="view_quantity">
    <div class="sc-modal-dialog">
        <div class="sc-modal-header">
            <span class="sc-title-bar">DELIVERY RECEIPT DETAILS</span>
            <span class="sc-close" onclick="scion.create.sc_modal('view_quantity').hide('all')">
                <i class="fas fa-times"></i>
            </span>
        </div>
        <div class="sc-modal-body">
            <form id="viewQuantityForm">
                @csrf
                <input type="hidden" id="purchase_order_detail_id" name="purchase_order_detail_id">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select name="split_type" id="split_type" class="form-control">
                            <option value="single">SINGLE DELIVERY RECEIPT</option>
                            <option value="split">SPLIT DELIVERY RECEIPT</option>
                        </select>
                    </div>
                </div>
            </form>
...
<div class="sc-modal-content" id="dr_list_modal" style="display:none;">
    <div class="sc-modal-dialog">
        <div class="sc-modal-header">
            <span class="sc-title-bar">DELIVERY RECEIPT LIST</span>
            <span class="sc-close" onclick="$('#dr_list_modal').hide();">
                <i class="fas fa-times"></i>
            </span>
        </div>
        <div class="sc-modal-body">
            <table class="table" id="dr_list_table">
                <thead>
                    <tr>
                        <th>DR Sequence</th>
                        <th>Item</th>
...
<script src="/js/backend/pages/purchasing/transaction/delivery_receipt.js"></script>
@endsection
