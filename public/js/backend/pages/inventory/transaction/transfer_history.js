$(function() {
    modal_content = 'transfer_history';
    module_url = '/inventory/transfer_history';
    module_type = 'custom';
    ...
    scion.create.table(
        ...
        [
            ...
            { data: "inventory.material.item_name",title: "Name", render: function(data, type, row, meta) {
                    return '<span class="expandable" title="' + data + '">' + data + '</span>';
                }
            },
            { data: "inventory.project.project_name",title: "From Project", render: function(data, type, row, meta) {
                    return '<span class="expandable" title="' + data + '">' + data + '</span>';
                }
            },
            { data: "project.project_name",title: "To Project", render: function(data, type, row, meta) {
                    return '<span class="expandable" title="' + data + '">' + data + '</span>';
                }
            },
