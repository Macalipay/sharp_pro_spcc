$(function() {
    modal_content = 'inventory_damage';
    module_url = '/inventory/damage';
    module_type = 'custom';
    page_title = "Inventory Damage";
    ...
    scion.create.table(
        ...
        [
            { data: "id", title:"<input type='checkbox' class='multi-checkbox' onclick='scion.table.checkAll()'/>", render: function(data, type, row, meta) {
                ...
                html += '<a href="#" class="align-middle edit" onclick="scion.record.edit('+"'/inventory/damage/edit/', "+ row.id +')"><i class="fas fa-pen"></i></a>';
                return html;
            }},
            {data: "inventory.material.item_code", title: "Code", render: function(data, type, row, meta) {
                    return '<span class="expandable" title="' + data + '">' + data + '</span>';
                }
        },
            {data: "inventory.material.item_name", title: "Item Name", render: function(data, type, row, meta) {
                    return '<span class="expandable" title="' + data + '">' + data + '</span>';
                }
            },
            {data: "inventory.project.project_name", title: "Project Name", render: function(data, type, row, meta) {
                    return '<span class="expandable" title="' + data + '">' + data + '</span>';
                }
            },
