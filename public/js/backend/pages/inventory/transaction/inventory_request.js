...
$(function() {
    ...
    module_url = '/inventory/inventory_request';
...
function preparation_func() {
    ...
    scion.create.table(
        ...
        [
            { data: "DT_RowIndex", title:`REQUEST LIST <span class='command'><button class="btn btn-sm btn-primary" onclick="editPO()">EDIT INVENTORY REQUEST</button></span>`, render: function(data, type, row, meta) {
                var html = "";
                html += `
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.purchase_orders.projects.length !== 0) {
                    if(data.purchase_orders.projects[0].project.region !== null) {
                        $('#po_ship_to_address1').text(`${data.purchase_orders.projects[0].project.barangay.name}, ${data.purchase_orders.projects[0].project.city.name}, ${data.purchase_orders.projects[0].project.province.name}, ${data.purchase_orders.projects[0].project.region.name}, Philippines, ${data.purchase_orders.projects[0].project.postal_code}`);
                    }
                    else {
